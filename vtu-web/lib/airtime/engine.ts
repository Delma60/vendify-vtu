...
/**
 * Auto-detect Nigerian network from phone number prefix.
 * Returns null for international or unrecognised numbers.
 */
...
/**
 * Normalise a phone number to international format (+234...).
 */
