...
function RoleModal({
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-base font-bold" style={{ color: B.text }}>
          Assign role — {user.displayName}
        </h3>
        <p className="mb-4 mt-1 text-sm" style={{ color: B.muted }}>
          Current role: <strong>{user.roleId}</strong>
        </p>
        ...
        <div className="mt-5 flex gap-3">
          <button
            onClick={onCancel}
            disabled={loading}
            className="flex-1 rounded-2xl border py-2.5 text-sm font-semibold hover:bg-gray-50 disabled:opacity-50"
            style={{ borderColor: B.border, color: B.text }}
          >
            Cancel
          </button>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm" style={{ color: B.muted }}>
            Manage accounts, roles, and wallet access.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            className="flex h-9 items-center gap-1.5 rounded-xl border px-3 text-sm transition hover:bg-gray-50"
            style={{ borderColor: B.border, color: B.muted }}
          >
            <Download size={14} />
            Export
