...
import { Zap, Loader2, CheckCircle2, RefreshCw, Mail, ArrowLeft, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="relative w-64 h-48 mx-auto mb-6">
        ...
        {/* Envelope body */}
        <svg viewBox="0 0 200 150" className="w-full h-full drop-shadow-2xl" fill="none">
          {/* Body */}
          <rect x="10" y="40" width="180" height="105" rx="8" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" />
          ...
          {/* Letter peeking out */}
          <rect x="50" y="15" width="100" height="70" rx="5" fill="rgba(255,255,255,0.95)" />

          {/* Code lines on letter */}
          <rect x="60" y="28" width="80" height="7" rx="3" fill="rgba(249,115,22,0.6)" />
          <rect x="68" y="42" width="64" height="5" rx="2.5" fill="rgba(249,115,22,0.3)" />
          <rect x="72" y="54" width="56" height="5" rx="2.5" fill="rgba(249,115,22,0.2)" />

          {/* VendPro label on envelope */}
          <text x="100" y="125" textAnchor="middle" fill="rgba(255,255,255,0.3)" fontSize="9" fontWeight="600" fontFamily="system-ui">
            VendPro
          </text>

          {/* Animated sparkles */}
          <circle cx="168" cy="22" r="3" fill="#F97316" opacity={tick >= 1 ? 1 : 0.2} />
          <circle cx="178" cy="32" r="2" fill="#22C55E" opacity={tick >= 2 ? 1 : 0.2} />
          <circle cx="158" cy="14" r="2" fill="#FBBF24" opacity={tick >= 3 ? 1 : 0.2} />
        </svg>
      </div>
  ...
  return (
    <div className="flex gap-3 justify-center">
      {Array.from({ length: 6 }).map((_, i) => {
        ...
        const isActive = !disabled && (filled ? i === value.length - 1 : i === value.length);
        return (
        ...
        <div className="relative z-10 space-y-10">
          <div>
            ...
            <p className="text-lg leading-relaxed" style={{ color: 'rgba(255,255,255,0.55)' }}>
              We sent a 6-digit code to confirm your email. Enter it and you're in.
            </p>
          </div>
